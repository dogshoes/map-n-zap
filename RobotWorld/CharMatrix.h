 ...
 */
 class CharMatrix {
   ...
   public:
     CharMatrix() {rows=0; cols=0; mat=0; min_value=0;max_value=255;mat_rows=0;};
     ...
     int NumberOfColumns() {return cols;};
     unsigned char MinimumValue() const {return min_value;};
     unsigned char MaximumValue() const {return max_value;};
 
     void SetMinumumValue(unsigned char min) {min_value=min;};
     void SetMaximumValue(unsigned char max) {max_value=max;};
