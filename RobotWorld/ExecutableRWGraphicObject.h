 ...
 **********************************************************************/
 ...
 public:
 	...
 	virtual robPOINT GetEntryPoint(void) {return m_EntryPoint;};
 	virtual robPOINT GetExitPoint(void) {return m_ExitPoint;};
 ...
 {
 public:
 	~CExecutableRWGraphicObjectListNode() {return;};
 ...
 {
 public:
 	CExecutableRWGraphicObjectListNode* GetHead(void) { return m_Head; }
 	...
 	bool GetShowCaptions(void) {return m_ShowCaptions;};
 	...
 	CExecutableRWGraphicObjectList() {m_Head = NULL; m_ProbabilityGrid = NULL; m_ShowCaptions = true;};
 	~CExecutableRWGraphicObjectList() {Purge();};
 	...
 	CExecutableRWGraphicObjectListNode* Head(void) { return m_Head; }
 private:
