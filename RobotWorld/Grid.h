...
class Grid : public CharMatrix
{
    ...
    public:
        ...
        {
            size = g.size;
            SetOrigin(g.origin[0], g.origin[1]);
        };
        ...
        double CornerAngle(int i)
        {
            return corner_ang[i % 4];
        };
        double CornerAngleNE()
        {
            return corner_ang[0];
        };
        double CornerAngleNW()
        {
            return corner_ang[1];
        };
        double CornerAngleSW()
        {
            return corner_ang[2];
        };
        double CornerAngleSE()
        {
            return corner_ang[3];
        };

        double CornerDistance(int i)
        {
            return corner_dist[i % 4];
        };
        double CornerDistanceNE()
        {
            return corner_dist[0];
        };
        double CornerDistanceNW()
        {
            return corner_dist[1];
        };
        double CornerDistanceSW()
        {
            return corner_dist[2];
        };
        double CornerDistanceSE()
        {
            return corner_dist[3];
        };
