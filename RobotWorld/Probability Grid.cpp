...
*******************************************************************************/
{
    ...
    if (BoundsRect.left > cWorldGridXSize - 1)
    {
        BoundsRect.left = cWorldGridXSize - 1;
    }

    if (BoundsRect.right < 0)
    {
        BoundsRect.right = 0;
    }

    if (BoundsRect.right > cWorldGridXSize - 1)
    {
        BoundsRect.right = cWorldGridXSize - 1;
    }
    ...
    if (BoundsRect.top > cWorldGridYSize - 1)
    {
        BoundsRect.top = cWorldGridYSize - 1;
    }

    if (BoundsRect.bottom < 0)
    {
        BoundsRect.bottom = 0;
    }

    if (BoundsRect.bottom > cWorldGridYSize - 1)
    {
        BoundsRect.bottom = cWorldGridYSize - 1;
    }
    ...
    ///*
    if (ProbGridBmpUpdateRect.left < BoundsRect.left)
    {
        ProbGridBmpUpdateRect.left = BoundsRect.left;
    }

    if (ProbGridBmpUpdateRect.left > BoundsRect.right)
    {
        ProbGridBmpUpdateRect.left = BoundsRect.right;
    }

    if (ProbGridBmpUpdateRect.right < BoundsRect.left)
    {
        ProbGridBmpUpdateRect.right = BoundsRect.left;
    }

    if (ProbGridBmpUpdateRect.right > BoundsRect.right)
    {
        ProbGridBmpUpdateRect.right = BoundsRect.right;
    }

    if (ProbGridBmpUpdateRect.top < BoundsRect.top)
    {
        ProbGridBmpUpdateRect.top = BoundsRect.top;
    }

    if (ProbGridBmpUpdateRect.top > BoundsRect.bottom)
    {
        ProbGridBmpUpdateRect.top = BoundsRect.bottom;
    }

    if (ProbGridBmpUpdateRect.bottom < BoundsRect.top)
    {
        ProbGridBmpUpdateRect.bottom = BoundsRect.top;
    }

    if (ProbGridBmpUpdateRect.bottom > BoundsRect.bottom)
    {
        ProbGridBmpUpdateRect.bottom = BoundsRect.bottom;
    }
    ...
    if ((ProbGridBmpUpdateRect.Width() == 0) || (ProbGridBmpUpdateRect.Height() == 0))
    {
        return;
    }
...
*******************************************************************************/
{
    ...
    if (SurfacePitch == SurfaceWidth * 2u)
    {
        SurfacePitch = SurfaceWidth;
    }
    ...
    if (DestRect.right >= (long)SurfaceWidth)
    {
        DestRect.right = SurfaceWidth - 1;
    }
    ...
    if (DestRect.bottom >= (long)SurfaceHeight)
    {
        DestRect.bottom = SurfaceHeight - 1;
    }
...
*******************************************************************************/
{
    ...
    if (DestHeight * m_ZoomLevel >= SurfaceHeight)
    {
        DestHeight = unsigned short(SurfaceHeight / m_ZoomLevel);
    }

    if (DestWidth * m_ZoomLevel >= SurfaceWidth)
    {
        DestWidth = unsigned short(SurfaceWidth / m_ZoomLevel);
    }
...
*******************************************************************************/
{
    ...
    if (UpdateRect.right > ClientRect.right)
    {
        UpdateRect.right = ClientRect.right;
    }

    if (UpdateRect.bottom > ClientRect.bottom)
    {
...
void CProbabilityGrid::RectifyPoint(CPoint* point)
{
    ...
    *******************************************************************************/
    ...
    if (point->x > m_DisplayResolution.x)
    {
        point->x = m_DisplayResolution.x;
    }
    ...
    if (point->y > m_DisplayResolution.y)
    {
        point->y = m_DisplayResolution.y;
    }
}
...
float CProbabilityGrid::GetPercentExploredArea()
{
    ...
    for (int i = 0; i < cWorldGridYSize; i++)
    {
        ...
        {
            if (GridValues[j] != cWorldGridInitialValue)
            {
                UpdatedGridPoints++;
            }
        }
...
void CPixelValueList::AddPixelValue(int R, int G, int B)
{
    ...
    if (CurrentPos == NULL)
    {
        ...
        if (PixelValues[HashValue] == NULL)
        {
            PixelValues[HashValue] = NewValue;
        }
        else
        {
    ...
    if (GetNumberOfRobots() > 1)
    {
        for (int i = 0; i < cMaxRobots; i++)
        {
            if (m_RobotList[i] == Robot)
            {
                ...
                for (; i < cMaxRobots - 1; i++)
                {
                    m_RobotList[i] = m_RobotList[i + 1];
                }
            }
        }
    }
