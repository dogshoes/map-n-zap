...
class RoverLocation
{
    ...
    public:
        ...
        RoverLocation(double lx, double ly, double lth)
        {
            x = lx;
            y = ly;
            th = lth;
...
class Rover
{
    ...
    public:
        Rover(int rows = ROVER_WIDTH, int columns = ROVER_LENGTH,
            ...
            : body(rows, columns, grid_size, NEUTRAL_NUMBER)
        {
            InitRover();
        };
        Rover(/*const*/ Rover &r)
        ...
        {
            InitRover();
            SetPathBuffer(r.PathBuffer());
        };
        Rover(const Grid &g) : body(g)
        {
            InitRover();
        };
