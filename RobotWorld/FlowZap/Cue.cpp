  ...
  **********************************************************************/
  ...
  void CCue::PaintPointer(CPaintDC* dc, int l)
  {
  	...
  	vertices[0].x = 7;    vertices[0].y = l-5;
  	vertices[1].x = 7;    vertices[1].y = l+5;
  	vertices[2].x = 17;   vertices[2].y = l+5;
  	vertices[3].x = 23;   vertices[3].y = l;
  	vertices[4].x = 17;   vertices[4].y = l-5;
  ...
  void CCue::Paint(CPaintDC * dc)
  {
  	...
  	*/
  	if  (fc->GetInstructionsSize() == 0) return;
  	...
  	*/
  	if (ptr != NULL) {
  		if (ptr->GetSafeHwnd() != NULL) m_location = ptr->GetCenter() - 1;
  		else m_location = fc->GetInstructionAtIndex(0)->GetCenter()-1;
  	} else m_location = fc->GetInstructionAtIndex(0)->GetCenter()-1;
