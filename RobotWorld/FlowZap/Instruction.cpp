...
void CInstruction::MouseClick(CPoint point)
{
    ...
    */
    if (this == fc->GetInstructionAtIndex(fc->GetInstructionsSize() - 1))
    {
        return;
    }
    ...
    */
    if (m_Moveable)
    {
        fc->m_MouseMode = mmFZSelected;
    }
    else
    {
        fc->m_MouseMode = mmFZIllegalMove;
    }
...
BOOL CInstruction::Between(CInstruction * a, CInstruction * b)
{
    ...
    ************************************************************************************************/
    ...
    if ((m_Index > a->GetIndex()) && (m_Index < b->GetIndex()))
    {
        return TRUE;
    }
...
****************************************************/
BOOL CInstruction::IsSelected()
{
    return m_Selected;
}

BOOL CInstruction::IsMoveable()
{
    return m_Moveable;
}

void CInstruction::SetIndex(int index)
{
    m_Index = index;
}

void CInstruction::MakeSelected(BOOL s)
{
    m_Selected = s;
}

int CInstruction::GetIndex()
{
    return m_Index;
}
/*************************************************
