 ...
 **********************************************************************/
 ...
 public:
 	void SetAddingHomeBase(bool Adding) {m_AddingHomeBase = Adding;};
 	bool GetAddingHomeBase(void) {return m_AddingHomeBase;};
 	...
 	void SetActiveRobot(CRobot* Robot) {m_ActiveRobot = Robot;};
 	CRobot* GetActiveRobot(void) {return m_ActiveRobot;};
 ...
 private:
 	...
 	unsigned long COLOR24(unsigned char R, unsigned char G, unsigned char B) {return COLOR32(R,G,B);};
