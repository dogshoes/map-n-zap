...
typedef enum {mmDefault, mmPlaceLabel, mmPlaceRedZone, mmErase, mmEdit,
              ...
              mmPlaceFinishLine, mmPlaceStartLine, mmPlaceLinePath, mmSearchArea, mmMoveRobot
             } TMouseMode;
...
class CRobotWorldView : public CView
{
    ...
    public:
        ...
        void SetCurrentRWGraphicObject(CRWGraphicObject* CurrentGraphicObject)
        {
            m_CurrentRWGraphicObject = CurrentGraphicObject;
        };
        CRWGraphicObject* GetCurrentRWGraphicObject(void)
        {
            return m_CurrentRWGraphicObject;
        };
