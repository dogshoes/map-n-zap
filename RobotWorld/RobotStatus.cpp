 ...
 **********************************************************************/
  ...
  {
  	if (point.x < m_MaxSpeedRect.left) return 0;
  	else if (point.x > (m_MaxSpeedRect.right - cSpeedballWidth)) return (m_MaxSpeedRect.Width() - cSpeedballWidth);
  	else return (point.x - m_MaxSpeedRect.left);
  }
  ...
  short CDbrRobotStatus::SpeedballLocationToMaxSpeed(int SpeedballLocation)
  {
  	...
  	if (Speed < 0) Speed = 0;
  	else if (Speed > cMaxSpeed) Speed = cMaxSpeed;
  	return Speed;
  }
  ...
  int CDbrRobotStatus::MaxSpeedToSpeedballLocation(short MaxSpeed)
  {
  	...
  	if (Location > (m_MaxSpeedRect.Width() - cSpeedballWidth)) Location = m_MaxSpeedRect.Width() - cSpeedballWidth;
