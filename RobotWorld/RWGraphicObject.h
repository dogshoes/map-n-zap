...
class CRWGraphicObject : public CObject
{
    public:
        ...
        void SetAnimationFrame(int Frame)
        {
            ...
            {
                Frame = GetNumberAnimationFrames() - 1;
            }
        ...
        virtual int GetNumberAnimationFrames(void)
        {
            return 0;
        };
        ...
        virtual void SetShowCaption(bool Visible)
        {
            m_ShowCaption = Visible;
        };
        virtual bool GetShowCaption(void)
        {
        ...
        virtual unsigned int GetZLayer(void)
        {
            return 0;
        };
        ...
        virtual unsigned short MinWidth(void)
        {
            return 0;
        };
        virtual unsigned short MinHeight(void)
        {
            return 0;
        };
        virtual void SetBounds(robRECT bounds);
        virtual void SetEditMode(TEditMode EditMode)
        {
            m_EditMode = EditMode;
        };
        TEditMode GetEditMode(void)
        {
            return m_EditMode;
        };
        ...
        virtual TRWGraphicObjectType GetObjectType(void)
        {
            return goNoObject;
        };
