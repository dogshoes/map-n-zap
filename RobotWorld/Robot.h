 ...
 **********************************************************************/
 ...
 typedef enum {stCalibrating, stWaiting, stDragging, stFollowingInstructions,
 	stRelocating, stFindPath, stAutoCalibrate, stExecuting, stJoysticking} TState;
 ...
 typedef enum {M0Back = 0, M0Front = 1, M1Back = 2, M1Front = 3,
 					...
 					M0Front_M1Front = 7, NoObstacle} TMotorObstacle;
 ...
 public:
 	...
 	void SetDrawPosition(robPOINT Position) {m_DrawPosition = Position;};
 	robPOINT GetDrawPosition(void) {return m_DrawPosition;};
 	void SetDrawHeading(double Heading) {m_DrawHeading = Heading;};
 	double GetDrawHeading(void) {return m_DrawHeading;};
 	void SetCommResponseTimeOut(long TimeOut);
 	bool GetExternalOutput(void) {return m_ExternalOutput;};
 	...
 	bool GetEnableRepositionOnUnknownObstacle(void) {return m_EnableRepositionOnUnknownObstacle;};
 	void SetEnableRepositionOnUnknownObstacle(bool Enable) {m_EnableRepositionOnUnknownObstacle = Enable;};
 	...
 	void StartWaitingForExternalInputChange() {m_StartWaitingForExternalInputChange = true;};
 	void SetExecutingRobotTask(bool Executing) {m_ExecutingRobotTask = Executing;};
 	void SetFollowingPath(CCTDPath* Path);
 	bool GetInstructionResultValid(void) {return m_RobotInstructionResult.Valid;};
 	void SetInstructionResultValid(bool Value) {m_RobotInstructionResult.Valid = Value;};
 	...
 	bool GetLearnRoom(void) {return m_UpdateProbabilityGrid;};
 	void SetLearnRoom(bool On) {m_UpdateProbabilityGrid = On;};
 	...
 	void SetTouchedHomeBase(bool Touched = false) {m_TouchedHomeBase = Touched;};
 	...
 	bool GetEnableObstacleBounce(void) {return m_EnableObstacleBounce;};
 ...
 //	void SendWallCalibrate(robPOINT P0, double H0, robPOINT P1, double H1, bool Corner, unsigned char FeelWheel);
 	...
 	bool GetOnHomeBase(void) {return m_OnHomeBase;};
 	...
 	robPOINT GetPosition(void) {return m_Position;};
 	robPOINT GetPositionError(void) {return m_PositionError;};
 	void SetPositionError(robPOINT Error);
 	double GetHeadingError(void) {return m_HeadingError;};
 ...
 //	void SetAutoCalibrate(bool AutoCalibrate);
 	CRobotWorldView* GetParent(void) {return m_Parent;};
 //	void AutoCalibrate(void);
 	void StopFindPath(void);
 	TState GetState(void) {return m_State;};
 	...
 	TObstacleSensitivity GetObstacleSensitivity(void) {return m_ObstacleSensitivity;};
 //	TTaskResult CalibrateAgainstCornerWall(CCornerWall* CalibrationZone);
 	short GetHandleLength(void) {return m_HandleLength;};
 	short GetMaxSpeed(void) {return m_MaxSpeed;};
