...
class CLaygo : public CDialog
{
    ...
    public:
        ...
        bool m_EnableLaygo;
        bool GetShownJoystick(void)
        {
            return m_ShownJoystick;
        };
        void SetShownJoystick(bool Shown)
        {
            m_ShownJoystick = Shown;
        };
        bool GetShownFlowZap(void)
        {
            return m_ShownFlowZap;
        };
        void SetShownFlowZap(bool Shown)
        {
            m_ShownFlowZap = Shown;
        };
