 ...
 **********************************************************************/
 ...
 public:
 	...
 	void SetProbabilityGrid(CProbabilityGrid* ProbGrid) {m_ProbGrid = ProbGrid;};
 	void SetParentWindowHandle(HWND ParentWindowHandle) {m_ParentWindowHandle = ParentWindowHandle;};
 	IPathPlanner();
