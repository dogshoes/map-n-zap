 ...
 **********************************************************************/
  ...
  *******************************************************************************/
  {
  	if ( (P1.x == P2.x) && (P1.y == P2.y) ) return ERRNoSolution;
  	if (P1.x == P2.x) {
  		Line->Vertical = TRUE;
  		Line->m = 0.0f;
  		Line->b = P1.x;
  ...
  *******************************************************************************/
  ...
  /*Take care of vertical lines*/
  	if (L.Vertical == TRUE) return ABS(P.x - L.b);
  /*Take care of horizontal lines*/
  	if (L.m == 0) return ABS(P.y - L.b);
  ...
  *******************************************************************************/
  {
  	if (L.Vertical == TRUE) {
  		if (P.x >= L.b) return TRUE;
  		else return FALSE;
  	} else {
  		if ( P.y >= (P.x * L.m + L.b) ) return TRUE;
  		else return FALSE;
  	}
  }
  ...
  *******************************************************************************/
  {
  	if (L1.Vertical != L2.Vertical) return FALSE;
  	if (L1.Vertical == TRUE) {
  		if (L1.b == L2.b) return TRUE;
  	} else {
  		if ( (L1.b == L2.b) && (L1.m == L2.m) ) return TRUE;
  	}
  	return FALSE;
  }
  ...
  *******************************************************************************/
  {
  	if (DisplacedSystem == NULL) return DisplacedPoint;
  	robPOINT Transform;
  ...
  *******************************************************************************/
  {
  	if (DisplacedSystem == NULL) return NonDisplacedPoint;
  	robPOINT Transform;
