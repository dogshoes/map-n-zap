...
long ICyeSrv::Connect(long wHnd, short NodeAddress, LPCTSTR ControlName)
{
    ...
    InvokeHelper(0x3, DISPATCH_METHOD, VT_I4, (void*)&result, parms, wHnd, NodeAddress, ControlName);
...
short ICyeSrv::Disconnect(long ConnectId)
{
    ...
    InvokeHelper(0x4, DISPATCH_METHOD, VT_I2, (void*)&result, parms, ConnectId);
...
long ICyeSrv::RegisterSimClient(long SimWHandle)
{
    ...
    InvokeHelper(0x5, DISPATCH_METHOD, VT_I4, (void*)&result, parms, SimWHandle);
...
void ICyeSrv::SetMotorVelocities(short M0Velocity, short M1Velocity)
{
    ...
    InvokeHelper(0x6, DISPATCH_METHOD, VT_EMPTY, NULL, parms, M0Velocity, M1Velocity);
}
...
void ICyeSrv::SetRobotHeadingCorrectionFactor(short Correction)
{
    ...
    InvokeHelper(0x7, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Correction);
}
...
void ICyeSrv::SetMaxPWM(short MaxPWM)
{
    ...
    InvokeHelper(0x9, DISPATCH_METHOD, VT_EMPTY, NULL, parms, MaxPWM);
}
...
void ICyeSrv::SetMotorsPWM(short M0PWM, short M1PWM)
{
    ...
    InvokeHelper(0xb, DISPATCH_METHOD, VT_EMPTY, NULL, parms, M0PWM, M1PWM);
}
...
void ICyeSrv::MoveTo(long X, long Y)
{
    ...
    InvokeHelper(0xc, DISPATCH_METHOD, VT_EMPTY, NULL, parms, X, Y);
}
...
void ICyeSrv::ResetPosition(long X, long Y, long H)
{
    ...
    InvokeHelper(0xe, DISPATCH_METHOD, VT_EMPTY, NULL, parms, X, Y, H);
}
...
short ICyeSrv::GetRadioStatus(short rNum)
{
    ...
    InvokeHelper(0x12, DISPATCH_METHOD, VT_I2, (void*)&result, parms, rNum);
...
void ICyeSrv::SetRadioStatus(short rNum, short nNewValue)
{
    ...
    InvokeHelper(0x13, DISPATCH_METHOD, VT_EMPTY, NULL, parms, rNum, nNewValue);
}
...
short ICyeSrv::GetRobotStatus(short rNum)
{
    ...
    InvokeHelper(0x14, DISPATCH_METHOD, VT_I2, (void*)&result, parms, rNum);
...
void ICyeSrv::SendP1(long P1)
{
    ...
    InvokeHelper(0x15, DISPATCH_METHOD, VT_EMPTY, NULL, parms, P1);
}
...
void ICyeSrv::SendP2(long P2)
{
    ...
    InvokeHelper(0x16, DISPATCH_METHOD, VT_EMPTY, NULL, parms, P2);
}
...
void ICyeSrv::SendP3(long P3)
{
    ...
    InvokeHelper(0x17, DISPATCH_METHOD, VT_EMPTY, NULL, parms, P3);
}
...
void ICyeSrv::SendP4(long P4)
{
    ...
    InvokeHelper(0x18, DISPATCH_METHOD, VT_EMPTY, NULL, parms, P4);
}
...
void ICyeSrv::SendP5(long P5)
{
    ...
    InvokeHelper(0x29, DISPATCH_METHOD, VT_EMPTY, NULL, parms, P5);
}
...
void ICyeSrv::SendP6(long P6)
{
    ...
    InvokeHelper(0x2a, DISPATCH_METHOD, VT_EMPTY, NULL, parms, P6);
}
...
void ICyeSrv::SendP7(long P7)
{
    ...
    InvokeHelper(0x2b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, P7);
}
...
void ICyeSrv::SendP8(long P8)
{
    ...
    InvokeHelper(0x2c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, P8);
}
...
void ICyeSrv::SendBuzzerFrequency(short BuzzerFrequency)
{
    ...
    InvokeHelper(0x19, DISPATCH_METHOD, VT_EMPTY, NULL, parms, BuzzerFrequency);
}
...
void ICyeSrv::SendBuzzerOn(long BuzzerOn)
{
    ...
    InvokeHelper(0x1a, DISPATCH_METHOD, VT_EMPTY, NULL, parms, BuzzerOn);
}
...
void ICyeSrv::SendFollowPath(short FollowPath)
{
    ...
    InvokeHelper(0x1b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, FollowPath);
}
...
void ICyeSrv::SendHandleLength(short HandleLength)
{
    ...
    InvokeHelper(0x1c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, HandleLength);
}
...
void ICyeSrv::SendMotorControlConstants(short Kp, short Ki, short Kd, short Kb, short Kpwm)
{
    ...
    InvokeHelper(0x1d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Kp, Ki, Kd, Kb, Kpwm);
}
...
void ICyeSrv::SendTurn(double Heading, short Velocity, short Diameter)
{
    ...
    InvokeHelper(0x1e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Heading, Velocity, Diameter);
}
...
void ICyeSrv::SendStraightVelocity(short Velocity, double Heading)
{
    ...
    InvokeHelper(0x1f, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Velocity, Heading);
}
...
void ICyeSrv::SendMaxSpeed(short MaxSpeed)
{
    ...
    InvokeHelper(0x20, DISPATCH_METHOD, VT_EMPTY, NULL, parms, MaxSpeed);
}
...
void ICyeSrv::SendHeading(double Heading)
{
    ...
    InvokeHelper(0x21, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Heading);
}
...
void ICyeSrv::SendMotorVelocities(short M0Velocity, short M1Velocity, short Priority)
{
    ...
    InvokeHelper(0x22, DISPATCH_METHOD, VT_EMPTY, NULL, parms, M0Velocity, M1Velocity, Priority);
}
...
void ICyeSrv::SendPosition(double X, double Y)
{
    ...
    InvokeHelper(0x24, DISPATCH_METHOD, VT_EMPTY, NULL, parms, X, Y);
}
...
void ICyeSrv::SendPositionDestination(double X, double Y)
{
    ...
    InvokeHelper(0x25, DISPATCH_METHOD, VT_EMPTY, NULL, parms, X, Y);
}
...
void ICyeSrv::ExecutePath(long PurgeOld, LPDISPATCH PathObject)
{
    ...
    InvokeHelper(0x26, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PurgeOld, PathObject);
}
...
void ICyeSrv::SetRobotStatus(short rNum, short nNewValue)
{
    ...
    InvokeHelper(0x27, DISPATCH_METHOD, VT_EMPTY, NULL, parms, rNum, nNewValue);
}
...
void ICyeSrv::SendSensitiveObstacleDetection(short Sensitive)
{
    ...
    InvokeHelper(0x28, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Sensitive);
}

void ICyeSrv::SendVelocityDirection(short Velocity, double Heading, short Priority)
{
    static BYTE parms[] = VTS_I2 VTS_R8 VTS_I2;

    InvokeHelper(0x2d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Velocity, Heading, Priority);
}
...
void ICyeSrv::SetRobotDestinationHeading(double Heading, short Velocity)
{
    ...
    InvokeHelper(0x2e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Heading, Velocity);
}
...
void ICyeSrv::SendPositionVelocityDestination(double X, double Y, short Velocity, short Priority)
{
    ...
    InvokeHelper(0x2f, DISPATCH_METHOD, VT_EMPTY, NULL, parms, X, Y, Velocity, Priority);
}
...
void ICyeSrv::SendInformationToTransmit(long Mask)
{
    ...
    InvokeHelper(0x30, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Mask);
}
...
void ICyeSrv::SendMessage(const VARIANT& MsgData)
{
    ...
    InvokeHelper(0x33, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &MsgData);
}
...
void ICyeSrv::SetRetryLimit(long NewLimit)
{
    ...
    InvokeHelper(0x35, DISPATCH_METHOD, VT_EMPTY, NULL, parms, NewLimit);
}
...
void ICyeSrv::SetPort(LPCTSTR NewPort)
{
    ...
    InvokeHelper(0x37, DISPATCH_METHOD, VT_EMPTY, NULL, parms, NewPort);
}

void ICyeSrv::SquareToWall(double Heading, float TravelTime, long SlipperySurface)
{
    static BYTE parms[] = VTS_R8 VTS_R4 VTS_I4;

    InvokeHelper(0x38, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Heading, TravelTime, SlipperySurface);
}
...
void ICyeSrv::SetFeelingMotor(short Motor)
{
    ...
    InvokeHelper(0x39, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Motor);
}

void ICyeSrv::CornerCalibrate(long X, long Y, double HO, short FeelWheel, float TravelTime, long SlipperySurface)
{
    static BYTE parms[] = VTS_I4 VTS_I4 VTS_R8 VTS_I2 VTS_R4 VTS_I4;

    InvokeHelper(0x3a, DISPATCH_METHOD, VT_EMPTY, NULL, parms, X, Y, HO, FeelWheel, TravelTime, SlipperySurface);
}
...
{
    static BYTE parms[] = VTS_R8 VTS_R8 VTS_I4 VTS_I4 VTS_I4;

    InvokeHelper(0x3b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, CornerHeading, WallHeading, HomeBaseLocationX, HomeBaseLocationY, NeedToGetInFrontOfHomeBase);
}
...
void ICyeSrv::SetHeadingDestination(double Heading, short Speed, short MotorEnable)
{
    ...
    InvokeHelper(0x3c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Heading, Speed, MotorEnable);
}
...
void ICyeSrv::SetEnableObstacleBounce(long Enable)
{
    ...
    InvokeHelper(0x3d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Enable);
}
...
void ICyeSrv::SetRAMData(long Address, const VARIANT& Data)
{
    ...
    InvokeHelper(0x3e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Address, &Data);
}
...
void ICyeSrv::SetRobotOnSeconds(long Seconds)
{
    ...
    InvokeHelper(0x3f, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Seconds);
}
...
void ICyeSrv::SetIntermittentBeep(long On)
{
    ...
    InvokeHelper(0x40, DISPATCH_METHOD, VT_EMPTY, NULL, parms, On);
}
...
void ICyeSrv::AddToPosition(double DeltaX, double DeltaY)
{
    ...
    InvokeHelper(0x41, DISPATCH_METHOD, VT_EMPTY, NULL, parms, DeltaX, DeltaY);
}
...
void ICyeSrv::AddToHeading(double Delta)
{
    ...
    InvokeHelper(0x42, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Delta);
}
...
void ICyeSrv::SetExternalOutput(long On)
{
    ...
    InvokeHelper(0x43, DISPATCH_METHOD, VT_EMPTY, NULL, parms, On);
}
